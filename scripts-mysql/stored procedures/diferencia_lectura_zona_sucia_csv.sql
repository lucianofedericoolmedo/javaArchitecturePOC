DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `diferencia_lectura_zona_sucia_csv`(IN remito_retiro_id CHAR(50), IN lectura_control_id CHAR(50), IN archivo CHAR(250), IN separador CHAR(50))
BEGIN 
	SET @stmt = CONCAT("
